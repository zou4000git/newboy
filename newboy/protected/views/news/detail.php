...
<head>
    ...
    <link rel="shortcut icon" href="favicon.ico"> <link href="<?php echo HOMECSS;?>/bootstrap.min14ed.css?v=3.3.6" rel="stylesheet">
    <link href="<?php echo HOMECSS; ?>/font-awesome.min93e3.css?v=4.4.0" rel="stylesheet">
 
    <link href="<?php echo HOMECSS; ?>/animate.min.css" rel="stylesheet">
    <link href="<?php echo HOMECSS; ?>/style.min862f.css?v=4.1.0" rel="stylesheet">
...
<body class="gray-bg">
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                ...
                                <div class="social-feed-box">
                                    <div class="social-avatar">
                                        <a href="#" class="pull-left">
                                            <img alt="image" src="<?php echo HOMEIMG; ?>/a1.jpg">
                                        </a>
                                ...
                                <div class="social-feed-box">
                                    <div class="social-avatar">
                                        <a href="#" class="pull-left">
                                            <img alt="image" src="<?php echo HOMEIMG; ?>/a2.jpg">
                                        </a>
                                        <div class="media-body">
                                            <a href="#">
                                                    避雷范儿
                                ...
                                <div class="social-feed-box">
                                    <div class="social-avatar">
                                        <a href="#" class="pull-left">
                                            <img alt="image" src="<?php echo HOMEIMG; ?>/a3.jpg">
                                        </a>
                                        <div class="media-body">
                                            <a href="#">
                                                    kamppi
                                    ...
                                    <div class="social-body">
                                        <p>
                                            这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论
                                            这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论
                                            这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论
                                            这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论这是一条超级长的评论
                                        </p>
                                ...
                                <div class="social-feed-box">
                                    <div class="social-avatar">
                                        <a href="#" class="pull-left">
                                            <img alt="image" src="<?php echo HOMEIMG; ?>/a5.jpg">
                                        </a>
                                        <div class="media-body">
                                            <a href="#">
                                                    kamppi
    ...
    <script src="<?php echo HOMEJS; ?>/jquery.min.js?v=2.1.4"></script>
    <script src="<?php echo HOMEJS; ?>/bootstrap.min.js?v=3.3.6"></script>
    <script src="<?php echo HOMEJS; ?>/content.min.js?v=1.0.0"></script>
