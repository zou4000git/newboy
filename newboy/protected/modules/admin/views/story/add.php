        ...
        <div class="col-sm-12">
            <div class="ibox">
                ...
                <div class="ibox-title">
                    <h5>故事</h5>
                    <small class="text-muted margin">&ensp;/ 新增</small>
                ...
                <div class="ibox-content">
                    <div class="row">
                        <div class="col-sm-6">
                            <!--                            <form action="index.php?r=admin/story/add" id="myform" class="form-horizontal m-t" method="post">-->
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-sm-9">
                                    <div style="width: 150%">
                                        ...
                                        <script id="container" class="content" name="content" type="text/plain"></script>
