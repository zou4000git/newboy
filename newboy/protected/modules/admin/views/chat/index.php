...
<head>
    ...
    <link rel="shortcut icon" href="favicon.ico"> <link href="<?php echo ADMINCSS ;?>/bootstrap.min14ed.css?v=3.3.6" rel="stylesheet">
    <link href="<?php echo ADMINCSS ;?>/font-awesome.min93e3.css?v=4.4.0" rel="stylesheet">
    <link href="<?php echo ADMINCSS ;?>/plugins/jsTree/style.min.css" rel="stylesheet">
                        ...
                        <div class="col-md-9 ">
                            ...
                            <!-- 聊天区消息展示-->
                                <div class="chat-message">
                                    <img class="message-avatar" src="<?php echo ADMINIMG ;?>/a1.jpg" alt="">
                                    <div class="message">
                                ...
                                <div class="chat-message">
                                    <img class="message-avatar" src="<?php echo ADMINIMG ;?>/a4.jpg" alt="">
                                    <div class="message">
